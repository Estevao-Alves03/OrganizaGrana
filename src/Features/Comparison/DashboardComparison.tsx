      ...
      <Card className="rounded-xl bg-slate-900 border-slate-600 w-[1380px] mt-6">
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <section>
              <button className="text-slate-300 font-bold rounded-lg px-3 py-2 bg-slate-800 hover:bg-slate-800/80">
                Mostrar meses / Ocultar meses
              </button>
            </section>
          </div>
        </CardHeader>
        <CardContent>
          ...
          <div className="border-green-700 border rounded-2xl px-4 py-1.5 w-[240px] flex justify-between mt-6">
            <section className="flex items-center gap-3">
              <div className="w-3 h-3 bg-green-600 rounded-xl" />
              <h1 className="text-white font-bold text-lg">Março de 2026</h1>
            </section>
