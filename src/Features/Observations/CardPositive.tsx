          ...
          <div className="space-y-6 max-w-2xl mx-auto">
            <div className="flex flex-col gap-3">
              <section className="flex items-start gap-2">
                <span className="flex-shrink-0 mt-1 border rounded-lg border-green-400 bg-green-200 p-1">
            ...
            <div className="mt-6">
              <section className="flex items-center gap-2">
                ...
                <h1 className="text-base font-medium text-gray-500"> Distribuição sugerida do saldo</h1>
              </section>
            </div>
