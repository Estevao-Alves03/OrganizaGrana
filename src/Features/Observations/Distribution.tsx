    ...
    <div className="space-y-6 px-4 max-w-2xl mx-auto">
      <div className="flex flex-col gap-3">
        <section className="flex items-start gap-2">
          ...
          <p>
            Parabens! Voce mantem um bom controle dos gastos fixos. Continue
            assim!
          </p>
        </section>
        <section className="flex items-start gap-2">
          ...
          <p>
            Use a distribuicao sugerida abaixo para otimizar cada real do seu
            saldo restante.
          </p>
        </section>
      </div>
      ...
      <div className="mt-6">
        <section className="flex items-center gap-3.5">
          ...
          <h1> Distribuicao sugerida do saldo</h1>
        </section>
      </div>
      ...
      <div className="space-y-2">
        <div className="flex justify-between items-center">
          <h3 className="font-medium text-gray-800">Reserva de Emergencia</h3>
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm text-gray-500">Cuide de voce, saia, divirta-se</p>
      </div>
